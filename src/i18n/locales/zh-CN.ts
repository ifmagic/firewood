const zhCN = {
  ...
  calculator: {
    expression: '表达式',
    placeholder: '点击输入或使用下方按钮',
    invalidExpression: '表达式无效',
    copiedWith: '已复制 {{value}}',
    savedToHistory: '已存入历史',
    ariaClear: '清空表达式',
    ariaBackspace: '退格',
    ariaOpenParen: '左括号',
    ariaCloseParen: '右括号',
  ...
  numbox: {
    ...
    formatCopyTs: '时间戳',
    formatCopyDate: '日期',
    clearConfirm: '清空全部历史记录？',
    confirmClear: '确认清空',
    historyExpand: '展开全部（{{count}} 条）',
    historyCollapse: '收起',
  },
  ...
  moxia: {
    ...
    bookNotFoundTitle: '作品文件不存在',
    bookNotFoundMessage: '该文件可能已被删除或移动，是否从最近打开列表中移除？',
    remove: '移除',
    book: '作品',
